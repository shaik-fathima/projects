...
export default function Footer() {
  return (
    <footer className='bg-slate-300 shadow-slate-800 shadow-sm sticky z-50 top-0  mb-0 '>
    ...
    {/*  other things*/}
           ...
           <div className="flex flex-wrap mt-0 space-x-5 sm:justify-center sm:mt-0  mr-3 ">
          
             <p className='ml-96 mt-0 '>&#169; All Right Reserved</p>
